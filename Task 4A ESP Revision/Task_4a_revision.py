...
# Identifies sales of different categories of products

def identify_sales_categories ():
    ...
    sorted_sales.plot(kind='bar', title='Sales by Category')



# Generates income and profit on different products

def generate_income_profit ():
    df = pd.read_csv("Task4a_RetailX_data.csv")
    ...
    print("Profit by Category:", category_profit)
